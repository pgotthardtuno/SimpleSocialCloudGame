...
let logoutHandler = () => { }; // Placeholder for the logout function from main.ts
// --- Setup Function ---
/**
 ...
 */
function setupUI(logoutBtn, userInfoEl, // Use HTMLElement for more general compatibility
onLogout) {
 ...
 */
function updateUserInfo(targetElement, // Allow passing the element directly
message) {
 ...
 */
function showLoginError(targetElement, // Allow passing the element directly
message) {
    const element = targetElement || userInfoElement; // Use passed element or default
    if (element) {
        element.textContent = message;
